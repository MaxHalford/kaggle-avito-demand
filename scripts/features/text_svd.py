...
svd = decomposition.TruncatedSVD(
    n_components=n_comp, algorithm='arpack', n_iter=10)
...
components['item_id'] = data['item_id'].values
components[train_mask].to_csv(
    'features/train/description_svd.csv', index=False)
components[~train_mask].to_csv(
    'features/test/description_svd.csv', index=False)
