...
def analyze(path):
    ...
    for f in tqdm(files):
        ...
        jobs.append(pool.submit(extract_features_from_file, f))

    # Wait for all futures to complete
    futures.wait(jobs, timeout=None, return_when=futures.ALL_COMPLETED)
...
if __name__ == '__main__':
    ...
    analyze('data/train_jpg.zip').to_csv('features/train/image_property.csv', index=False)
